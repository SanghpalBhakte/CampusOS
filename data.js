...
export const TIMETABLE = {
  1: [ // Monday
    ...
    { time: "15:00", end: "17:00", subject: "Multi Disciplinary Minor (MDM)",code: "MDM",    room: "LT-3",  teacher: "Faculty",   type: "lab" },
  ],
  2: [ // Tuesday
    { time: "10:00", end: "11:00", subject: "DS-AI-A2 / WD-AI-C2 / DEMP-AI-D2", code: "LAB", room: "AI-A2/C2/D2", teacher: "Faculty", type: "lab" },
    { time: "11:00", end: "12:00", subject: "DS-AI-A2 / WD-AI-C2 / DEMP-AI-D2", code: "LAB", room: "AI-A2/C2/D2", teacher: "Faculty", type: "lab" },
    { time: "12:00", end: "12:45", subject: "Recess",                           code: "REC", room: "—",         teacher: "—",         type: "off" },
  ...
  3: [ // Wednesday
    { time: "10:00", end: "11:00", subject: "Community Engagement (AI-C2,D2)", code: "CE",   room: "AI-C2,D2", teacher: "Coordinator", type: "project" },
    { time: "11:00", end: "12:00", subject: "Community Engagement (AI-C2,D2)", code: "CE",   room: "AI-C2,D2", teacher: "Coordinator", type: "project" },
    { time: "12:00", end: "12:45", subject: "Recess",                           code: "REC",  room: "—",        teacher: "—",         type: "off" },
  ...
  4: [ // Thursday
    ...
    { time: "12:00", end: "12:45", subject: "Recess",                           code: "REC",  room: "—",         teacher: "—",         type: "off" },
    { time: "12:45", end: "13:45", subject: "Community Engagement Lab (AI-A2,B2,C2,D2)", code: "CE", room: "AI-A2,B2,C2,D2", teacher: "Coordinator", type: "project" },
    { time: "13:45", end: "14:45", subject: "Community Engagement Lab (AI-A2,B2,C2,D2)", code: "CE", room: "AI-A2,B2,C2,D2", teacher: "Coordinator", type: "project" },
    { time: "14:45", end: "15:00", subject: "Recess",                           code: "REC",  room: "—",         teacher: "—",         type: "off" },
  ],
  5: [ // Friday
    { time: "10:00", end: "11:00", subject: "DEMP-AI-C2 / WD-B2 / DS-D2",       code: "LAB",  room: "AI-C2/B2/D2", teacher: "Faculty", type: "lab" },
    { time: "11:00", end: "12:00", subject: "DEMP-AI-C2 / WD-B2 / DS-D2",       code: "LAB",  room: "AI-C2/B2/D2", teacher: "Faculty", type: "lab" },
    { time: "12:00", end: "12:45", subject: "Recess",                           code: "REC",  room: "—",         teacher: "—",         type: "off" },
    ...
    { time: "14:45", end: "15:00", subject: "Recess",                           code: "REC",  room: "—",         teacher: "—",         type: "off" },
    { time: "15:00", end: "17:00", subject: "Community Engagement Lab (AI-A2,B2)", code: "CE", room: "AI-A2,B2", teacher: "Coordinator", type: "project" },
  ],
  6: [ // Saturday
